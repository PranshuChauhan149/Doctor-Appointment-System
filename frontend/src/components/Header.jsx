...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap px-6 md:px-10 bg-primary rounded-lg relative'>
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
        <p className='lg:leading-tight md:leading-tight leading-tight font-semibold text-white lg:text-5xl text-3xl md:text-4xl'>Book Appointment <br /> With Trusted Doctor</p>
